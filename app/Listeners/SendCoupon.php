...
use App\Notifications\WelcomeTestingLaravelWaitingListNotification;
...
class SendCoupon
{
    ...
    {
        if ($event->subscriber->hasTag('testing-laravel-waiting-list')) {
            $this->upcastSubscriber($event->subscriber)->notify(new WelcomeTestingLaravelWaitingListNotification());
        }
    }
