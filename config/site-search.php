...
return [
     ...
     */
    'default_profile' => \App\Support\Search\DocsSearchProfile::class,
     ...
     * of a `SiteSearchIndex` model.
     */
    'default_indexer' => App\Support\Search\DocsSearchIndexer::class,
     ...
     */
    'crawl_site_job' => App\Support\Search\CrawlSiteJob::class,
];
