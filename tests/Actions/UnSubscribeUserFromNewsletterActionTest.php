...
it('unsubscribes the user to the spatie email list', function () {
    ...
    Http::fake([
        "https://spatie.mailcoach.app/api/email-lists/4af46b59-3784-41a5-9272-6da31afa3a02/subscribers?filter%5Bemail%5D={$email}" => Http::response(['data' => [['uuid' => '1234', 'email' => $user->email]]]),
