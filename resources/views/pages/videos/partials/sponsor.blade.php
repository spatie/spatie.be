                ...
                <div class="wrap-inset md:items-center" style="--cols: 1fr auto">
                    ...
                    <h2 class="title-xl">
                     ...
                     <div class="mt-8 md:flex">
                        ...
                        <a class="mt-2 md:mt-0 font-sans-bold cursor-pointer border-l-2 border-green-light bg-green hover:bg-green-dark justify-center flex items-center px-6 py-2 rounded-full md:rounded-l-none text-white" href="https://github.com/sponsors/spatie" target="_blank">
                            <span>Become a GitHub Sponsor</span>                                             
                        </a>
                    </div>
                    @endif
