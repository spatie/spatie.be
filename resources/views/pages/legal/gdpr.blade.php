                ...
                <div class="markup markup-titles counters markup-lists links-underline links-blue">
                    ...
                    <ol class="counters-upper-alpha">
                        <li>
                            ...
                            processing of data, including Personal Data as defined below (hereinafter, the "<strong>Main
                                agreement</strong>");
                        </li>
                        <li>
                            ...
                            (the "<strong>Processing agreement</strong>").
                        </li>
                    </ol>
                    ...
                    <ol class="counters-lower-roman">
                        ...
                        <li>
                            <strong>Data subject(s)</strong>: the identifiable individual person whose Personal Data is
                            processed.
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>Processor</strong>: each individual or legal entity who for the benefit of the
                            Controller processes Personal Data.
                        </li>
                        <li>
                            <strong>Sub Processor</strong>: every third party that is brought in by the Processor to
                            process Personal Data for the benefit of the Processor, without being subjected to the
                            direct authority of the Processor.
                        </li>
                        <li>
                            <strong>Personal data</strong>: all information about an identified or identifiable natural
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>The Processing by the Processor is done solely on the basis of written instructions from the
                        ...
                        <li>If the Employees of the Controller process Personal Data themselves, the responsibility for
                        ...
                        <li>The Controller must keep a register of the processing activities that take place under his
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>
                            <p>For the proper implementation of the tasks as Processor, he uses the following
                                Subprocessors:</p>
                            <ul>
                                <li>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            organisational measures (hereinafter referred to as the "<strong>Safety Measures</strong>")
                    ...
                    <ol class="counters-level-2">
                        <li>
                            <p>If the Processor finds a Data Leak, he reports this without delay and at the latest
                                within 24 hours to the Controller. In this notification at least, the following is
                                described and reported:</p>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            and the <strong>sui generis</strong> database right.
                        </li>
                        <li>
