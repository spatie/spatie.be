@extends('layout.default', [
    ...
    <div class="section-group pt-0">
        <section id="jobs">
            <div class="wrap">
                <div class="markup markup-titles markup-chapters markup-lists links-underline links-blue">
                    <p>
                    ...
                    <ol class="markup-list-upper-alpha">
                        <li>
                    ...
                    <ol class="markup-list-lower-roman">
                        <li><strong>General data protection regulation</strong> or GDPR: the Regulation (EU)
                        ...
                        <li><strong>Data subject(s)</strong>: the identifiable individual person whose Personal Data is processed.
                        </li>
                        <li><strong>Controller</strong>: each individual or legal entity who determines
                         the purposes and means of the processing of Personal Data.
                     </li>
                     <li><strong>Processor</strong>: each individual or legal entity who for the benefit of the Controller processes Personal Data.
                     </li>
                     <li><strong>Sub Processor</strong>: every third party that is brought in by the Processor to process Personal Data for the benefit of the Processor, without being subjected to the direct authority of the Processor.
                     </li>
                     <li><strong>Personal data</strong>: all information about an identified or identifiable natural
                        person; an identifiable person is considered a natural person that can be identified directly or indirectly, in particular by reference to an identifier
                        such as a name, an identification number, location information, an online
                        identifier or one or more elements that characterises the physical,
                        physiological, genetic, mental, economic, cultural or social identity of that natural person.
                    </li>
                    <li><strong>Privacy legislation</strong>: the entire Belgian and European data protection
                    ...
                    <li><strong>Processing</strong>: any processing or set of processing related to Personal Data
                    ...
                    <li><strong>Data leak</strong>: a security breach of Personal Data which inadvertently or
                    ...
                    <li><strong>Supervisory authority</strong>: in Belgium this is the Commission for the
                        Protection of Privacy, starting from 25 May 2018 it will be reformed into the
                        Data Protection Authority.
                    </li>
                    <li><strong>Employee(s)</strong>: the persons who are authorised by the parties for the
                ...
                <ol class="markup-list-chapters">
                    <li>The Processor undertakes to only process Personal Data on the basis of written instructions of the Controller, arising from the Main Agreement. The Main Agreement and the Processors Agreement jointly determine the subject and the duration of the Processing.</li>
                    <li>The Processor and his Staff process the Personal Data on behalf of the Controller in the framework of the services and objective described below:
                        <br>
    ...
    <ol class="markup-list-chapters">
        <li>
            ...
            <ol class="markup-list-lower-roman mb-8">
                <li>
