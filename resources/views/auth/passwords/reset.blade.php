        ...
        <div class="card py-12 gradient gradient-green shadow-lg text-white">
            <form class="space-y-6" method="POST" action="{{ route('password.update') }}">
                ...
                <x-field>
                    ...
                    <input id="email" type="email" class="form-input w-full @error('email') border-pink @enderror"
                ...
                <x-field>
                    ...
                    <input id="password" type="password"
                           class="form-input w-full @error('password') border-pink @enderror" name="password" required
