                    ...
                    <x-purchase-assignment :assignment="$assignments->first()" :showImage="false" theme="white">
                        <div class="items-center grid gap-4 bg-gray-50 px-6 py-6">
                            ...
                            @if ($assignments->first()->purchasable->getting_started_url)
                                <a class="block w-full text-xs md:text-base" href="{{ $assignments->first()->purchasable->getting_started_url }}">
                                    <button class="w-full cursor-pointer bg-green-dark bg-opacity-75 hover:bg-opacity-100 rounded-sm border-2 border-transparent justify-center flex items-center px-6 py-2 font-sans-bold text-white transition-bg duration-300 focus:outline-none focus:border-blue-light whitespace-no-wrap">
                                        Getting started
                                    </button>
                                </a>
                            @endif
                        ...
                        <div class="">
                            ...
                            <div class="">
                                <div class="px-6 flex justify-between items-center text-xs py-4 border-b border-gray-lighter">
                                                ...
                                                <div class="flex flex-wrap justify-between">
                                                    <div class="w-full">
                                                        <div class="font-bold uppercase tracking-wide mb-2 flex items-center justify-between">
                                                            ...
                                                            <div class="font-normal normal-case text-xs {{ $license->isExpired() ? 'text-pink-dark' : '' }}">
                                                                {{ $license->isExpired() ? 'Expired on' : 'Expires on' }} {{ $license->expires_at->format('Y-m-d') }}
                                                                <a class="link-black link-underline" href="{{ route('products.buy', [$license->assignment->purchasable->product, $license->assignment->purchasable, $license]) }}">
                                                        ...
                                                        <div class="pb-4">
                                                            ...
                                                            >
                                                                ...
                                                                <span class="break-normal text-xs right-0 text-center underline select-none cursor-pointer" onclick="copyLicense(this, '{{ $license->key }}')"><svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="copy" class="w-4 h-4 fill-current" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><g class="fa-group"><path class="fa-secondary" fill="currentColor" d="M352 96V0H152a24 24 0 0 0-24 24v368a24 24 0 0 0 24 24h272a24 24 0 0 0 24-24V96z" opacity="0.4"></path><path class="fa-primary" fill="currentColor" d="M96 392V96H24a24 24 0 0 0-24 24v368a24 24 0 0 0 24 24h272a24 24 0 0 0 24-24v-40H152a56.06 56.06 0 0 1-56-56zM441 73L375 7a24 24 0 0 0-17-7h-6v96h96v-6.06A24 24 0 0 0 441 73z"></path></g></svg></span></code>
                                                        </div>
                                                    </div>
