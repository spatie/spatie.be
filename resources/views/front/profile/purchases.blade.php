...
>
    ...
    <div class="px-3 sm:px-16 md:px-10 lg:px-16 pb-20">
        <section class="w-full max-w-[1080px] mx-auto px-7 lg:px-0 mt-8 sm:mt-16 mb-12">
            <h1 class="font-druk uppercase text-[50px] sm:text-[72px] leading-[0.9] font-bold mb-6">Purchases</h1>
        ...
        @if(session()->has('sold_purchasable'))
            ...
            @endphp
            <section class="w-full max-w-[1080px] mx-auto px-7 lg:px-0 mb-12">
