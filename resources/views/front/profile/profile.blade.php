...
>
    ...
    <div class="px-3 sm:px-16 md:px-10 lg:px-16 pb-20">
        <section class="w-full max-w-[1080px] mx-auto px-7 lg:px-0 mt-8 sm:mt-16">
            <h1 class="font-druk uppercase text-[50px] sm:text-[72px] leading-[0.9] font-bold mb-6">My profile</h1>
            ...
            <div class="bg-oss-purple-extra-dark shadow-oss-card rounded-[20px] p-7 md:py-12 md:px-12 mt-8 max-w-[640px]">
