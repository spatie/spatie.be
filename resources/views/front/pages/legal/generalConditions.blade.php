                ...
                <div class="markup markup-titles counters markup-lists links-underline links-blue">
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            SPATIE and the client, unless otherwise explicitly agreed upon in writing between both
                            parties.
                        </li>
                        <li>
                            ...
                            telefax or otherwise, regardless of a written confirmation of SPATIE.
                        </li>
                        <li>
                            No other specification, description, publication, written or oral commitment, will be part
                            of these conditions nor will it be deemed to have references to them in these conditions.
                        </li>
                        <li>
                            Any purchase, payment or other terms and conditions of the client shall not apply, unless
                            they have been accepted expressly in writing by SPATIE, even if the conditions of the client
                            exclude these conditions.
                        </li>
                        <li>
                            All quotations and offers made by or on behalf of SPATIE are without engagement and may be
                            withdrawn by SPATIE as long as SPATIE has not accepted the order or task following a
                            quotation or offer in writing. All quotations and offers are also subject to amendments of
                            the order by the client or due to price changes from the suppliers.
                        </li>
                        <li>
                            SPATIE reserves the right to refuse any order or task without giving any reason.
                        </li>
                        <li>
                            The placing of an order or task with SPATIE is valid as the acceptance of these general
                            sales conditions, to be consulted on the SPATIE website at <a
                                    href="https://spatie.be/legal">https://spatie.be/legal</a>.
                        </li>
                        <li>
                            The person placing the order or task in the name of the client is assumed as being
                            authorised. He bears together with his principal all possible responsibility vis-à-vis third
                            parties.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>
                            If no fixed price is agreed with regard to the execution of the work, SPATIE will charge the
                        ...
                        <li>
                            ...
                            expressly agreed damage compensation between both parties for additional administrative and
                            legal costs.
                        ...
                        <li>
                            Any complaint will be thoroughly investigated by SPATIE if, at the risk of cancellation, it
                            is
                            submitted by registered letter within 8 days after delivery of the goods and/or services.

                        </li>
                        <li>
                            Complaints of the client on the invoice received must be remitted to SPATIE by registered
                            letter within eight days, otherwise they are null and void. The written complaint must
                            clearly
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            <ol class="counters-lower-alpha">
                                ...
                                <li>
                                    The cancellation must take place before the delivery took place or before SPATIE in
                                    any form or capacity has begun with the agreed work.
                                </li>
                                <li>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            laid out in the original agreement, or specifications agreed on afterwards, regardless of at
                            what moment.
                        </li>
                        <li>
                            SPATIE will notify the client as soon as possible when a change by an intermediate party,
                            because of a to be agreed upon change or supplement to the specifications, will affect the
                            time of completion of the work.
                        </li>
                        <li>
                            If a fixed price was agreed for the work, SPATIE will inform the client in advance if the to
                            be agreed upon change or supplement to the work will have as a result that the agreed price
                            will be exceeded. Unless an objection is submitted in writing, the client will be presumed
                            to have agreed with the additional work.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            the issue of the necessary documents or from the signature of the agreement.
                        </li>
                        <li>
                            ...
                            returning corrected tests or delaying meetings, has remained in default.
                        </li>
                        <li>
                            If exceeding the time limit (of delivery) takes place, SPATIE will notify the client as soon
                            as
                            possible.
                        </li>
                        <li>
                            ...
                            conflicting clause, not give rise to refusal of the delivery and will not give rise to any
                            compensation.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>
                            Business and software are, from the moment they have been made available by SPATIE to the
                            client, for his account and risk.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            SPATIE accepts legal obligations relating to common law damages as far as that is evident
                            from this article 9.
                        </li>
                        <li>
                            <p>In the case of chargeable shortcoming in the performance of the contract, SPATIE is only
                                ...
                                part of the assignment. Any liability of SPATIE for any other form of damage is
                                excluded, including additional damages in whatever form, compensation for indirect
                                damage or consequential loss or damage due to lost profits. SPATIE is in no way liable
                                for delay damages, damages for loss of data, damage due to exceeding the delivery
                                deadline due to changed circumstances, damage as a result of the acquiring of inadequate
                                cooperation, information or materials by the client, and the damage as a result of
                                information provided by SPATIE and advises whose contents are not explicitly part of a
                                written agreement. Defects in the materials that were stored by SPATIE, will not
                                compromise its responsibility and cannot cause a demand on damage-compensation.
                            </p>
                        </li>
                        <li>
                            Condition for any right to compensation is always that the client, after the damage has
                            occurred, within a period of two weeks, reports it by registered mail to SPATIE.
                        </li>
                        <li>
                            SPATIE is not liable for errors or defects if these are due to software or hardware or other
                            materials that were not delivered by SPATIE and that are defective and/or of which SPATIE
                            didn't know that they would be used along with the products/services delivered by them, or
                            the fact that others than SPATIE have made changes to the products/services.
                        </li>
                        <li>
                            The client indemnifies SPATIE for all damage that SPATIE may suffer as a result of
                            third-party liability related to the goods or services supplied by SPATIE, including:
                            <ul>
                                <li>
                                    claims of third parties, including employees of the client, who suffer damage
                                    arising out of wrongful actions by employees of SPATIE that were put at the disposal
                                    of the client and work under his supervision or on his indications;
                                </li>
                                <li>
                                    claims of third parties, including employees of SPATIE, that in connection with the
                                ...
                                <li>
                                    ...
                                    services delivered by SPATIE if the defect in the materials was hidden from SPATIE.
                                </li>
                            </ul>
                        </li>
                        <li>
                            The client is responsible for the use and the correct application in his organisation of the
                            equipment, the software and the services to be provided by SPATIE.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            If the client fails to fulfil one of his obligations towards SPATIE, requests the cessation
                            of payment or is in a state of bankruptcy, SPATIE has the right without further notice of
                            default or judicial intervention being required, to dissolve, all or certain, at the choice
                            of SPATIE, agreements concluded with the client, without prejudice to other legal rights due
                            to SPATIE. All payments due shall become immediately due and payable.
                        </li>
                        <li>
                            When the client does not fulfil any obligations resting on him on the basis of these general
                            conditions or an agreement concluded with SPATIE, then SPATIE, without prejudice to its
                            other rights, is entitled to suspend the agreed work until the client complies with his
                            obligations.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            The client acknowledges that SPATIE is the exclusive owner or licensee of all trademarks,
                            patents or copyright attached to all products and services delivered by SPATIE. The client
                            agrees that for the duration of the agreement and thereafter, he will not challenge any
                            intellectual and/or industrial property right of which SPATIE is the owner or licensee.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>
                            All disputes relating to these terms and conditions or agreements concluded by a SPATIE will
                            always be decided by the courts of the district of Antwerp, Belgium.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            SPATIE for the benefit of the client relating to the development and maintenance of web
                            sites and software on the basis of detailed specifications and functional requirements.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            completeness for which the client is responsible, will be specified in writing which
                            website/software will be developed.
                        </li>
                        <li>
                            SPATIE is responsible for the correction of errors due to them. Authors improvements that
                            results in changes, additions or omissions beyond our control, will be charged according to
                            the current rates.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            SPATIE will deliver the developed websites and/or software to the client in accordance with
                            the specifications.
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            shows defects or does not satisfy the written specifications, the client will inform SPATIE
                            immediately in a written and detailed acceptance report of the defects. SPATIE will in that
                            case restore the reported deficiencies within a reasonable time. The repair shall be free if
                            the software was developed for a fixed price.
                        </li>
                        <li>
                            Small defects that do not stand in the way of operational commissioning are no reason to
                            refuse the acceptance. When actually using the website/software or parts thereof, the client
                            has accepted the website/software or these parts.
                        </li>
                        <li>
                            The website/software is further deemed to have been accepted after acceptance by the client,
                            or 8 days after the ready for use delivery if the client has not informed SPATIE in writing
                            about the defects, or after the repair of the reported defects.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            models, designs, and so on, all the sketches, designs, photos, pictures, web pages and web
                            sites, banners, interpretations, concepts, solutions, software, etc…, designed by SPATIE
                            whatever the technique may be, are the property of SPATIE. They should in no way be
                            counterfeited or reproduced or distributed in anyway whatsoever. The reneging or the cession
                            of the above must in no way, unless permitted expressly and in advance, be regarded as the
                            right to ownership.
                        </li>
                        <li>
                            The designed website/software is the intellectual property of SPATIE and as such protected
                            by the law. The website/software can therefore not be transferred free of charge or with a
                            considered title, in whatever form, in whole or in part, to any third party, subject to the
                            express written permission of SPATIE.
                        </li>
                        <li>
                        ...
                        <li>
                            All the elements and data provided by the client to SPATIE are provided for inclusion in the
                            website/software, including all texts, images, logos, graphics, photos, audio or video films
                            and the updates are supposed to be and to remain the exclusive property of the client.
                        </li>
                        <li>
                            To the extent that all or part of these elements are not the exclusive property of the
                            client, the client guarantees that he has all the necessary permissions for the use of these
                            elements. These permissions should, as appropriate, refer to:

                            <ul>
                                <li>
                                    the right of reproduction on any digital or other carrier, including the right to
                                    the adjustment needed for the transfer from one carrier to the other;
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    such as cable, satellites, internet, including the provision to the public of the
                                    elements in such a way that everyone has access to it at the place and time that he
                                    individually choses.
                                </li>
                            </ul>
                        </li>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            activities for the benefit of the client to be performed by SPATIE. Web hosting refers to
                            the putting out of a website on a webserver.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        ...
                        <li>
                            ...
                            against their association with other texts, declarations, elements, etc. The client accepts
                            that SPATIE according to the technical requirements can change the stored elements. This
                            without prejudice to any right of the author to oppose changes that could harm his honour or
                            his good name.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            carried out by SPATIE for the benefit of the client concerning registration, transfer or
                            trade domain names.
                        </li>
                        <li>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            competent authority, SPATIE is at no time responsible for any refusal. Also damages
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            period of 1 year. The client undertakes to respect the 2 months ' notice period in writing,
                            which shall be done 2 months before the end of the subscription day, be it during the
                            initial period or during the period of extension.
                        </li>
                        <li>
                            Invoices for the registration of one or more domain names are always payable within 8
                            calendar days after the date of invoice unless otherwise stated on the invoice.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            The client undertakes, when requested by SPATIE, to provide the domain name or to let it be
                            provided with at least two name servers which in turn are configured correctly, to direct
                            data traffic via the domain name in the correct lane. He will under no circumstances cancel
                            the name servers of SPATIE if he does not rent a corresponding web hosting package with
                            SPATIE.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            ...
                            e-mail address should be functional at all times and not be involved on one of the domain
                            names that are rented with SPATIE by any client. The client shall at all times comply with
                            the requirements of this e-mail-address, and will, if necessary, pass on a change of e-mail
                            address to SPATIE.
                        </li>
                    </ol>
                    ...
                    <ol class="counters-level-2">
                        <li>
                            The client takes note of the fact that SPATIE acts only as an intermediary between the
                            client and the authority that assigns the domain name. Applying and maintaining the domain
                            name needs is simply and only to be considered as an additional client service. The client
                            acknowledges that SPATIE has no decisive control over requesting, recording, adjusting,
                            maintaining or cancelling a domain name, in particular with regards the regulation which is
                            handled by ICANN, OpenSRS, DNS BE or any other relevant authority. SPATIE will in no way be
                            held liable if the client loses control of the domain name as a result of such regulations
                            or any other reason. SPATIE will for that matter always seek to defend the interests of the
                            client.
                        </li>
                    </ol>
