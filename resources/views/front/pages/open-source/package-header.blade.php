    ...
    <div @class([
        ...
        <footer class="flex items-top w-full justify-between px-2 relative z-0">
            ...
            <div class="pt-[12px] pb-2">
                <div class="bg-[url(/images/packages/footer-pattern-left.png)] bg-repeat-x w-[635px] h-[13px] bg-contain py-2"></div>
            </div>
            <div class="border-t border-t-[{{$color}}] h-[20px] z-5 pt-[3px]">
                <span class="text-gheist text-xs">spatie.be/open-source</span>
            </div>
            <div class="pt-[12px] pb-2">
                <div class="bg-[url(/images/packages/footer-pattern-right.png)] bg-repeat-x w-[13px] h-[13px] bg-contain"></div>
            </div>
        </footer>
    </div>
</body>
