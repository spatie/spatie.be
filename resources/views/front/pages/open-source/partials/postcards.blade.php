<section
    id="postcards"
    class="border-t border-oss-gray-extra-dark pt-20 mb-20 max-w-[1320px] w-full mx-auto"
    x-data="{}"
    x-init="() => {
...
>
    <div class="flex justify-between items-end mb-20 w-full">
        <h2 class="font-druk uppercase font-bold text-[96px] leading-[0.9]">All<br/>postcards</h2>
