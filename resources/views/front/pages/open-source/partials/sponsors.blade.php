<div class="wrap mb-16">
    <div class="filter-backdrop bg-opaque px-16 xl:px-32 py-12 md:pt-8 max-w-md mx-auto shadow-lg rounded-sm">
        ...
        <div class="mt-6 md:mt-4 flex flex-col md:flex-row items-center justify-between gap-4">
