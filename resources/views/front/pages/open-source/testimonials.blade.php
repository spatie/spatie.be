            ...
            <div id="testimonials" class="py-24 px-16 bg-white shadow-lg text-lg markup markup-lists">
                <div x-show="testimonial === 'tom'">
                    <p>
                        ...
                        <p>
                            I just wanted to take the official chance to share my story with you. <del>But please exclude me from the backpack giveaway.</del> 😉
                            ...
                            <p>
                                ...
                                <p>
                                    ...
                                    <p>
                                        ...
                                        In addition two of your packages allowed me to create three plugins and this year Alex trusted me to take over one of your packages. 🙏
                ...
                <div x-show="testimonial === 'axel'">
                    ...
                    <p>At work, we use several of your packages, in particular laravel-permission and laravel-medialibrary which allow us to do in a few minutes everything related to policies and images on our clients' sites.</p>

                    <p>We also use laravel-backup on all our Laravel sites and are thinking about a new workflow with laravel-backup-server to manage the backups of all our sites!</p>

                    <p>For my part, you have helped me enormously to progress. I didn't just use your packages, I also looked at their source code, which allowed me to learn quite a bit.</p>

                    <p>Recently, I created two packages, one to allow my team to quickly start a Laravel project, it's a simple Laravel command to install various presets (fortify, sanctum, nova, laravel-permission, pest, graphql, etc.) and another one I'm still creating.<br>
                        This package allows you to set up a customizable onboarding interface. We have a particular need on a project where Excel is no longer sufficient so I am trying to create this fairly large package.
                    </p>
                ...
                <div x-show="testimonial === 'tim'">
                    ...
                    <ul>
                        ...
                        <li>inspired me to write my own packages (not quite there yet to open source, unfortunately)</li>
                    </ul>

                    <p>Thanks for all the great work and for being such an integral part of the php/laravel community!</p>
                ...
                <div x-show="testimonial === 'christian'">
                    ...
                    <p>With your help we can realize portals like wecreateyour.com or our internal production control. We use the medialibrary for our custom 3D Preset files. <br>
                        Next year we plan to replace our Magento shop with a Vanilo.io based shop, where we also will use a lot of spatie Package and the Medialibrary. This will be a huge advantage over the slow , expensive Magento experience. <br>
                        With your Dashboard Tutorial we will soon setup several monitors in our production to show our employees which orders still have to be processed or how many packages we sent per day. We also use your query builder in our projects, which allow us to filter advanced search queries for our orders. In combination with the frontend tools this is a huge time saving.<br>
                ...
                <div x-show="testimonial === 'jamie'">
                    <p class="text-xl">
                        ...
                        <p class="text-xl">
                        All the ones I've used in my projects just saves time, I've got plans for the backup tool when my project launches, and no doubt there'll be others there when I need them, if you need it, there's a good chance the guys at Spatie have already got it covered!
                    </p>
                    <p>
