@php
/** @var \App\Domain\Experience\Projections\UserAchievementProjection|null $achievement */
@endphp
            ...
            <div class="wrap wrap-6 items-stretch">
                ...
                <div class="pt-8 | md:pt-0 sm:col-start-3 sm:col-span-4">
                    ...
                    <div class="mt-8 text-lg links-underline links-blue markup markup-titles markup-lists">
                        ...
                        <p class="mt-4">
                            You've successfully completed this series!
                        </p>

                        <p>
                            Download your certificate <a href="{{ action([\App\Http\Controllers\AchievementsController::class, 'certificateDownload'], $series->getAchievementSlug()) }}">here</a>.
                        </p>
                    </div>
                </div>
            </div>
