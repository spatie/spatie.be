...
>
    <div class="section section-group">
        <section class="section overflow-visible">
            <div class="wrap">
                <h2 class="title line-after mb-12">Public Service Announcement: Black Friday Deals</h2>
                <iframe style="aspect-ratio: 16 / 9" class="w-full"
                        src="https://www.youtube.com/embed/KMD8oP_9Z7U" title="YouTube video player"
                        frameborder="0"
