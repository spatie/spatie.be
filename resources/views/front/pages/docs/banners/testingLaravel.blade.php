<aside class="z-20 fixed flex bottom-0 w-full">
    <div class="mx-auto">
        <div class="bg-pink text-gray-darkest flex flex-col items-end sm:flex-row sm:items-center justify-center rounded-t p-2 pr-6 shadow-light text-xs sm:text-sm">
            <div class="flex items-center">
                ...
                <div>
                    <div>
                        ...
                        <span class="font-semibold">Testing Laravel</span>
                    </div>
                </div>
            </div>
            <a href="https://testing-laravel.com">
