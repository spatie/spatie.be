<aside class="z-20 fixed flex bottom-0 w-full p-2">
    <div class="mx-auto">
        <div class="bg-blue text-white flex flex-col items-end sm:flex-row sm:items-center justify-center rounded p-2 sm:p-4 shadow-light text-xs sm:text-sm">
            ...
            <a href="https://mailcoach.app">
                <button class="mt-2 md:mt-0 ml-4 px-2 py-1 rounded text-blue bg-white uppercase tracking-wide font-semibold">
                    Learn&nbsp;more
                </button>
            </a>
