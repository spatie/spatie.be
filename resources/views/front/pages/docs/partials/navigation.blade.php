...
<<<<<<< HEAD
        <a class="ml-auto flex items-center text-xs link-gray link-underline" href="{{ $alias->githubUrl }}/edit/{{$alias->slug}}/docs/{{ $page->slug }}.md"
=======
...
>>>>>>> 3e718a94cb8ce1140a52de2e7223a9140738087f
            target="_blank">
            Edit
