...
<style>
    :root {
        --accent-color: {{ $color }};
        @if($repositoryModel->light_button_text)
...
<div class="docs-branded-header bg-oss-gray-light p-8 md:p-14 rounded-[8px] text-[18px] mb-5">
    ...
    <div class="md:flex justify-between">
        <div class="flex space-x-2 mb-4 md:mb-0">
            ...
            <div>
                <a href="{{ $alias->githubUrl }}/issues" target="_blank" class="bg-[--accent-color] text-[--button-text-color] rounded drop-shadow-sm px-4 py-2 inline-flex items-center space-x-2 text-[16px] hover:brightness-90">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path @if($repositoryModel->light_button_text) fill="#fff" @else fill="#172A3D" @endif d="M10 2C8.34375 2 7 3.34375 7 5V6H13V5C13 3.34375 11.6562 2 10 2ZM4.28125 5.21875L3.75 4.6875L2.69063 5.75L3.22187 6.28125L5.00312 8.0625L5 8.5V10.25H2.75H2V11.75H2.75H5V12C5 12.85 5.2125 13.65 5.5875 14.3531L3.56875 16.3687L3.0375 16.9L4.09687 17.9594L4.62812 17.4281L6.49375 15.5625C7.39687 16.4531 8.63438 17 10 17C11.3656 17 12.6031 16.4531 13.5063 15.5656L15.3719 17.4312L15.9031 17.9625L16.9625 16.9031L16.4312 16.3719L14.4125 14.3531C14.7875 13.6531 15 12.85 15 12V11.75H17.25H18V10.25H17.25H15V8.5V8.05937L16.7812 6.27812L17.3125 5.74687L16.25 4.69062L15.7188 5.22187L13.9375 7.00312L13.5 7H6.5H6.05937L4.28125 5.21875ZM9.25 15.4187C7.67812 15.075 6.5 13.675 6.5 12V8.5H13.5V12C13.5 13.675 12.3219 15.075 10.75 15.4187V10.75V10H9.25V10.75V15.4187Z"/>
                    </svg>
