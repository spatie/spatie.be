            ...
            <article class="md:col-span-7 lg:col-span-6">
                @if($repository->aliases->first()->slug !== $alias->slug)
                    <div class="mb-10 p-5 flex text-sm bg-oss-green-pale rounded-[8px] markup-code">
                        ...
                        <div class="ml-4">
                            <p>
                                You are viewing the documentation for <strong>an older version</strong> of this package. You can check the version you are using with the following command:
                            </p>
                            <div class="mt-4">
