    ...
    <div class="wrap wrap-8">
        <div class="sm:col-span-3 sm:col-start-2">
            <div class="markup links-underline links-blue">
                ...
                <p class="text-lg">
                    ...
                    been downloaded worldwide {{ App\Models\Repository::humanReadableDownloadCount() }} times.<br>
                    Our <a href="http://git-awards.com/users?utf8=✓&type=world&language=php">top ranking</a> amongst PHP
            ...
            <div class="card gradient gradient-blue text-black mt-16">
                ...
                <ul class="mt-4 text-lg bullets bullets-blue links-underline links-black">
                    <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> <a
                                href="{{ route('open-source.packages') }}">Open source packages</a></li>
                    <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> <a
                                href="{{ route('products.index') }}">Our products</a> and <a
                                href="{{ route('courses.index') }}">videos</a></li>
                    <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> <a
                                href="{{ route('web-development') }}">Laravel, React &amp; Vue development</a></li>
                </ul>
            </div>
        </div>
        <div class="hidden | sm:block sm:col-span-3 sm:col-start-6">
            <a class="illustration is-right is-rotated is-postcard-without-caption h-full"
               href="{{ route('open-source.postcards') }}" title="Postcards">
