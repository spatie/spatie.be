<section id="clients" class="section">
    ...
    <div class="wrap grid grid-cols-2 mt-8 col-gap-8 row-gap-2 | md:grid-cols-4 md:col-gap-16">
        ...
        <div class="text-center"><a class="w-full max-w-logoclient inline-block" href="https://flux50.com" target="_blank" rel="noreferrer noopener">{{ svg('clients/flux50') }}</a></div>
        <div class="text-center"><a class="w-full max-w-logoclient inline-block" href="https://skylineeurope.be" target="_blank" rel="noreferrer noopener">{{ svg('clients/skyline') }}</a></div>
