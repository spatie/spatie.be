...
<ul class="bullets bullets-green">
    @if($profile == 'front' || $profile == 'back')
        ...
        <li><span class="icon">{{ svg('icons/far-angle-right') }}</span> A large community platform for a US client</li>
    @endif

    @if($profile == 'front')
        <li><span class="icon">{{ svg('icons/far-angle-right') }}</span> The design of online courses for a Laravel audience</li>
    @endif
    @if($profile == 'back')
        <li><span class="icon">{{ svg('icons/far-angle-right') }}</span> Development of online courses for a Laravel audience</li>
    @endif
    @if($profile == 'marketing')
        <li><span class="icon">{{ svg('icons/far-angle-right') }}</span> Growth of our in-house applications for the Laravel ecosystem like <a href="https://myray.app" target="_blank" rel="noopener nofollow">Ray</a>, <a href="https://mailcoach.app" target="_blank" rel="noopener nofollow">Mailcoach</a> or <a href="https://flareapp.io" target="_blank" rel="noopener nofollow">Flare</a></li>
        <li><span class="icon">{{ svg('icons/far-angle-right') }}</span> Promotion of online courses for a Laravel audience</li>
    @endif
