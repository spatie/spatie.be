            ...
            <div class="markup links-underline links-blue">
                ...
                <ul class="bullets bullets-green">
                    @unless($marketing ?? false)
                        <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> A full-time position in a
                    ...
                    @else
                        <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> A <strong>part-time
                                contract</strong>, as an employee or freelancer.
                            <br>Starting with a regime of 8–10 hours per week, with potential to grow in the future.
                        </li>
                        <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> Work on location in
                            Antwerp, partially from home or even <strong>fully remote</strong>.
                        </li>
                        <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> A remuneration package with
                            a competitive salary and optional extras tailored to your personal needs.
                        </li>
                        <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> Any software you prefer or
                            need.
                        </li>
                        <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> You may start immediately.
                        </li>
                ...
                @unless($marketing ?? false)
                    ...
                    <ul class="bullets bullets-green">
                        <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> Partially remote work to
                            help you get in the zone or combine work and family
                        </li>
                        <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> A modern office in the
                            centre of Antwerp, right in between 2 train stations
                        </li>
                        <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> Standing desks and a roof
                            terrace
                        </li>
                        <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> A genuine drive to learn
                            from each other: code reviews, in-house presentations and chit-chat on Slack
                        </li>
                        <li><span class="icon">{{ app_svg('icons/far-angle-right') }}</span> A flat company structure
                            where you can make a clear difference
                        </li>
