            ...
            <div class="markup links-underline links-blue">
               <h2 class="title-2xl">Our offer
                ...
                <ul class="bullets bullets-green">
                    ...
                    @else
                        <li><span class="icon">{{ svg('icons/far-angle-right') }}</span> A <strong>part-time contract</strong>, as employer or freelancer.
                            <br>Starting with a regime of 1 day a week, with potential to grow in the future.</li>
