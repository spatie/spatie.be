<x-page background="/backgrounds/vacancies.jpg" title="Frontend designer vacancy" description="Vacancy for a frontend designer. Location: Antwerp.">
    ...
    <section id="banner" class="banner" role="banner">
        <div class="wrap">
            ...
            <p class="mt-4">
                <span class="icon mr-2 opacity-50 fill-current text-blue">{{ svg('icons/far-angle-left') }}</span> <a href="{{ route('vacancies.index')}}" class="link-underline link-blue">Vacancies overview</a>
            </p>
        </div>
    </section>
                ...
                <div class="sm:col-span-4">
                    <div class="markup links-underline links-blue">
                        ...
                        <div class="mt-16">
                            ...
                            <p>
                                We are a compact but powerful team of (currently) <a href="{{ route('about') }}#team">11 web enthousiasts</a> based in Antwerp.
                                We've made quite a name with our open source work in the Laravel ecosystem and recently started building more and more tools for developers.
                                We share a lot of what we learn: be it in open source projects, ebooks &amp; courses, videos or in-house knowledge sharing sessions.
                            </p>
                        ...
                        <div class="mt-16">
                            ...
                            <ul class="bullets bullets-green">
                                ...
                                <li>
                                    <span class="icon">{{ svg('icons/far-angle-right') }}</span> 
                                    design and implement concrete marketing actions, like banners, newsletters or one-page promo sites;
                                </li>
                                <li>
                                    <span class="icon">{{ svg('icons/far-angle-right') }}</span> 
                            ...
                            <p>Lastly, you'll have a say in what you'll be working on. No really, we áre listening. If you're curious to see how we work, these public <a href="https://guidelines.spatie.be">guidelines</a> could give you a first impression.</p>
                        </div>

                        <div class="mt-16">
                            <h3 class="title">This defines you</h3>

                            <p>First of all, you're a designer; of beautiful graphics, of one-pagers and entire applications. Though we are looking for someone with a sharp eye, it's indispensable that you also have technical skills to implement your ideas.
                            You work together with the frontend and backend developers in the team, so you know how to communicate about a design as well.</p>
                            ...
                            <ul class="bullets bullets-green">
                                ...
                                <li>
                                    <span class="icon">{{ svg('icons/far-angle-right') }}</span> 
                                    You know the Internet and have a thorough understanding of HTML, CSS and JavaScript and how they work together. Basic knowledge of PHP and Laravel are a big plus. Check out our <a href="#stack">technology stack</a> at the bottom to get a better understanding of where you'd end up.
                                </li>
                                <li>
                                    <span class="icon">{{ svg('icons/far-angle-right') }}</span> 
