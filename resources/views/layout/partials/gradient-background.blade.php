@props([
    ...
    'uStrength' => '3',
    'uSpeed' => '0.05',
    'mobilePlaceholder' => '/images/gradient-placeholder.webp',
    'mobilePlaceholderHeight' => 1920,
    'mobilePlaceholderWidth' => 1080,
])
    ...
    @if($mobilePlaceholder)
        <div class="sm:motion-safe:hidden absolute top-0 left-0 right-0 z-0 pointer-events-none">
            <img
                ...
                alt=""
                width="{{ $mobilePlaceholderWidth }}"
                height="{{ $mobilePlaceholderHeight }}"
                fetchpriority="high"
            >
