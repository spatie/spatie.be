<div class="px-3 sm:px-12 font-pt">
    <header x-data="{ open: window.innerWidth >= 720 }" x-on:click.outside="open = false" x-on:resize.window="open = window.innerWidth >= 720" class="w-full max-w-screen-xl mx-auto p-5 sm:px-[40px] sm:py-[30px] flex-none z-10 my-5 rounded | bg-white shadow-light | print:bg-transparent print:shadow-none">
