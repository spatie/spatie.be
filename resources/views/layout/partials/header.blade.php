<header class="pt-8 flex-none z-10 | bg-trueblack md:shadow-light md:py-8 | print:bg-transparent print:shadow-none">
    <div class="wrap leading-loose | md:leading-none md:flex md:items-stretch">
        ...
        <div class="grid grid-cols-2  items-start col-gap-8 | md:grid-cols-1 md:row-gap-6 md:justify-end md:justify-items-end md:ml-auto">
            <nav class="flex links links-white | md:row-start-2">
                @include('layout.partials.menu')
            </nav>
            <nav class="grid links links-white | md:opacity-75 md:row-start-1 md:grid-flow-col md:items-center md:gap-6 md:text-xs | print:hidden">
