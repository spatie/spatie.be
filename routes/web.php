...
Route::get('/profile/{userUuid}/{slug}/og-image', [PublicProfileController::class, 'ogImage']);
Route::get('/profile/{userUuid}/{slug}/certificate', [PublicProfileController::class, 'certificate']);
